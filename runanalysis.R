...
Sub_train <- read.table("./UCI HAR Dataset/UCI HAR Dataset/train/subject_train.txt")
...
Sub_test <- read.table("./UCI HAR Dataset/UCI HAR Dataset/test/subject_test.txt")

# read data description
variable_names <- read.table("./UCI HAR Dataset/UCI HAR Dataset/features.txt")
...
write.table(total_mean, file = "./UCI HAR Dataset/UCI HAR Dataset/tidydata.txt", row.names = FALSE, col.names = TRUE)
